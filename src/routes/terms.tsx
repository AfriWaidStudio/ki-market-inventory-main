  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm">
      ...
      <p className="mt-2 text-muted-foreground">
        KI Market Inventory is a personal tracking and decision-support tool. Nothing shown in the
        app is financial, investment, tax, or legal advice. All KI outputs are probabilistic
        estimates, not guarantees. You are solely responsible for any trades you place elsewhere.
      </p>
      ...
      <p className="mt-2 text-muted-foreground">
        Do not abuse the service, attempt to access other users' data, share credentials, or use the
        app for illegal activity.
      </p>

      <h2 className="mt-6 text-lg font-semibold">Availability</h2>
      <p className="mt-2 text-muted-foreground">
        The service is provided "as is" without warranty. We may change or discontinue features at
        any time.
      </p>
    </main>
  );
