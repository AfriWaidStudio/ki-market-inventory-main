  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="text-xs font-bold uppercase tracking-widest text-slate-400 drop-shadow-sm">
          {label}
        </div>
        <div className={cn("mt-3 text-3xl font-black tabular-nums tracking-tight", style.text)}>
          {value}
        </div>
